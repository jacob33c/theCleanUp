...
func addToArrayWithDistance(riderCLLocation: CLLocation, driverCLLocation: CLLocation, index: Int, uid: String, hasBeenShown: Bool, address: String, amount: Int, note: String) -> locationWithDistance {
    var request         = locationWithDistance()
